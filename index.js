document.addEventListener("DOMContentLoaded", () => {
  const memberData = {
    ...
    "마사지 A": {
      members: ["로지", "엘사", "브로디", "댄"],
      travel:
        "레이저 아레나에서 도보 10분, 또는 택시 기본요금 거리입니다. 낙오된 멤버가 없는지 서로 잘 챙겨주세요!",
    },
    "마사지 B": {
      members: ["윌리엄", "아일라", "진도", "도큐"],
      travel:
        "레이저 아레나에서 택시로 약 10-15분 소요됩니다. 낙오된 멤버가 없는지 서로 잘 챙겨주세요!",
    },
    "가족 공예": {
      members: [
        "소피아",
      ...
      travel:
        "레이저 아레나에서 택시로 약 15-20분 소요됩니다. 인원이 많으니 3-4대 택시를 함께 잡아 이동하세요!",
    },
  };
